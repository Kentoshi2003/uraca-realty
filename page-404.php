...
<head>
<meta charset="utf-8" />
<title>Page Not Found | Uraca Realty PH</title>
<!-- Stylesheets -->
          ...
          <div class="row">
            <div class="col-xl-12">
              <div class="error-page__inner">
                ...
                <a href="index.php" class="theme-btn btn-style-one">Back to Home <span class="arrow-right"><img src="images/icons/btn-icon-1.png" alt=""></span></a>
              </div>
            </div>
          </div>
        </div>
