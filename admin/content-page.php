...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($sectionMap[$pageSlug] as $sectionKey) {
        ...
        $sectionPayloads[$sectionKey] = [
            ...
            'button_url' => trim((string) ($_POST['sections'][$sectionKey]['button_url'] ?? '')),
...
<form class="admin-card" method="post" enctype="multipart/form-data">
  ...
  <?php foreach ($sectionMap[$pageSlug] as $sectionKey): $section = cms_section($pageSlug, $sectionKey); ?>
    <div class="admin-form-section">
